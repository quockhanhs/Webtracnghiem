...
if(@$_GET['fdid'] && $_SESSION['key']=='nam3523018') {
$id=@$_GET['fdid'];
...
//xóa người dùng
if(isset($_SESSION['key'])){
if(@$_GET['demail'] && $_SESSION['key']=='nam3523018') {
$demail=@$_GET['demail'];
...
//gỡ gói câu hỏi
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'rmquiz' && $_SESSION['key']=='nam3523018') {
$eid=@$_GET['eid'];
...
//thêm gói câu hỏi
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addquiz' && $_SESSION['key']=='nam3523018') {
$name = $_POST['name'];
...
//thêm câu hỏi
if(isset($_SESSION['key'])){
if(@$_GET['q']== 'addqns' && $_SESSION['key']=='nam3523018') {
$n=@$_GET['n'];
$eid=@$_GET['eid'];
$ch=@$_GET['ch'];
...
else if( $_SESSION['key']!='nam3523018')
{
