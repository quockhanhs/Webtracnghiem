...
<div class="row">
<div class="col-lg-6">
<span class="logo">WEB TRẮC NGHIỆM</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>MENU</b></a>
    </div>
    <!-- kiểm tra điều kiện điều hướng và tiến hành điều hướng -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Câu hỏi<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=4">Thêm câu hỏi</a></li>
            <li><a href="dash.php?q=5">Xóa câu hỏi</a></li>
...
<tr><td><b>STT</b></td><td><b>Chủ đề</b></td><td><b>Tổng số câu hỏi</b></td><td><b>Điểm</b></td><td><b>Thời gian</b></td><td></td></tr>';
$c=1;
...
<!--kết thúc giao diện-->
<!--danh sách quản lí người dùng-->
<?php if(@$_GET['q']==1) {

$result = mysqli_query($con,"SELECT * FROM user") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>STT</b></td><td><b>Tên</b></td><td><b>Giới tính</b></td><td><b>Đại Học</b></td><td><b>Email</b></td><td><b>Điện thoại</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
...
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>STT</b></td><td><b>Môn học</b></td><td><b>Email</b></td><td><b>Ngày</b></td><td><b>Thời gian</b></td><td><b>Người làm</b></td><td></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$date = $row['date'];
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Thông tin đề tài</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Nhập tiêu đề đề tài" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="total" name="total" placeholder="nhập số lượng câu hỏi" class="form-control input-md" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="right" name="right" placeholder="nhập số điểm được cộng khi trả lời đúng" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="wrong" name="wrong" placeholder="Nhập số điểm bị trừ khi trả lời sai" class="form-control input-md" min="0" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="time" name="time" placeholder="nhập thời gian làm bài" class="form-control input-md" min="1" type="number">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="tag" name="tag" placeholder="nhập tag để search đề tài" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="desc" class="form-control" placeholder="miêu tả đề tài"></textarea>  
  </div>
</div>
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Danh sách câu hỏi</b></span><br /><br />
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <textarea rows="3" cols="5" name="qns'.$i.'" class="form-control" placeholder="viết câu hỏi số '.$i.' here..."></textarea>  
  </div>
</div>
<!-- Text input-->
<div class="form-group">
...
<select id="ans'.$i.'" name="ans'.$i.'" placeholder="Chọn câu trả lời đúng " class="form-control input-md" >
   <option value="a">chọn đáp án cho câu hỏi '.$i.'</option>
